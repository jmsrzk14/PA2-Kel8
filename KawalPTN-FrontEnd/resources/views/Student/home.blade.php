    ...
    <div class="container p-0 mb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{asset('/FrontEnd/img/Poster.jpg')}}" alt="">
            </div>
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{asset('/FrontEnd/img/Poster2.jpg')}}" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(65, 76, 141, 0.7);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Best Online Tryout</h5>
                                    <h1 class="display-3 text-white animated slideInDown">Sukses UTBK bersama KAWAL PTN</h1>
                                    <p class="fs-5 text-white mb-4 pb-2">AYO... BURUAN PESAN PAKET TRYOUT MU DI SINI SEKARANG JUGAAA-!!!</p>
