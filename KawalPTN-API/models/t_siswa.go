...
type T_Siswa struct {
	...
	Sekolah              *string    `json:"sekolah" gorm:"default:null"`
	Asal_Sekolah         *string    `json:"asal_sekolah" gorm:"not null"`
	...
	Pilihan1_UTBK        *int       `json:"pilihan1_utbk" gorm:"default:null"`
	Pilihan2_UTBK        *int       `json:"pilihan2_utbk" gorm:"default:null"`
	Pilihan1_UTBK_Aktual *int       `json:"pilihan1_utbk_aktual" gorm:"default:null"`
	Pilihan2_UTBK_Aktual *int       `json:"pilihan2_utbk_aktual" gorm:"default:null"`
}
